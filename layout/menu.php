<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar ftco-navbar-light site-navbar-target" id="ftco-navbar">
	<div class="container">
			<a class="navbar-brand" href="?stranka=domu"><span><?= mb_substr(MOJE_UDAJE["jmeno"],0,1); ?></span><span><?= mb_substr(MOJE_UDAJE["jmeno"],1); ?></a>
		...
		<div class="collapse navbar-collapse" id="ftco-nav">
			<ul class="navbar-nav nav ml-auto">
				...
				?>
					<li class="nav-item"><a href="<?= $odkaz; ?>" class="nav-link"><span><?= $polozkaMenu["text"]; ?></span></a></li>
				<?php endforeach; ?>
				<li class="nav-item dropdown">
				   ...
				   <a class="dropdown-item" href="?stranka=prihlaseni" class="nav-link">Přihlášení</a>
                   <?php else : ?>   
				   ...
				   <a class="dropdown-item" href="?stranka=odhlasit" class="nav-link">Odhlásit</a>
				     <?php if ($prihlasenyUzivatel->jeAdministrator()) : ?>
