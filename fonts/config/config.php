...
/* postup1
$sluzby = [
    ["id" => "1", "nazev" => "Programování", "popis" => "Programování dynamických webových stránek.",
     "ikona" => "flaticon-ux-design", "cena" => "2000"],
    ["id" => "2", "nazev" => "Kódování", "popis" => "Kódování šablon webových stránek.", 
    "ikona" => "flaticon-web-design", "cena" => "1500"],
    ["id" => "3", "nazev" => "Lektorování", "popis" => "Výuka programování a kódování.", 
    "ikona" => "flaticon-innovation", "cena" => "1800"],
];  
*/

/* postup2 
$sluzby = [ 
    ["sluzba" => new Sluzba("1", "Programování", "Programování dynamických webových stránek.", "flaticon-ux-design", "2000")], 
    ["sluzba" => new Sluzba("2", "Kódování", "Kódování šablon webových stránek.", "flaticon-web-design", "1500")],
    ["sluzba" => new Sluzba("3", "Lektorování", "Výuka programování a kódování.", "flaticon-innovation", "1800")]
    ];
*/
...
/*
$sluzby = [
    ["sluzba" => najdiSluzbuPodleId(1, $pdo)],
    ["sluzba" => najdiSluzbuPodleId(2, $pdo)],
    ["sluzba" => najdiSluzbuPodleId(3, $pdo)]
];
*/

//postup3 - jednoduché pole-nefunguje
/*
$sluzby = [najdiSluzbuPodleId(1, $pdo), najdiSluzbuPodleId(2, $pdo), najdiSluzbuPodleId(3, $pdo)];
*/ /*
$sluzby = [
    new Sluzba("1", "Programování", "Programování", "flaticon-ux-design", "2000"),
    new Sluzba("2", "Kódování", "Kódování stránek.", "flaticon-web-design", "1500")
]; 
*/
//postup4
