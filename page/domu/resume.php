			...
			<div class="row">
				...
				<div class="col-md-9">
					...
					<div id="page-3" class="page three">
						...
						<div class="row">
						<?php foreach($vedlejsiSchopnosti as $vSchopnost) : ?>
							<div class="col-md-6 animate-box">
								<div class="progress-wrap ftco-animate">
									<h3><?= $vSchopnost["schopnost"]; ?></h3>
									<div class="progress">
										<div class="progress-bar color-1" role="progressbar" aria-valuenow="<?= $vSchopnost["hodnota"]; ?>"
											aria-valuemin="0" aria-valuemax="100" style="width:<?= $vSchopnost["hodnota"]; ?>%">
											<span><?= $vSchopnost["hodnota"]; ?>%</span>
										</div>
									</div>
								</div>
							</div>
