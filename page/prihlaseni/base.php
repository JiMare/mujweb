            ...
            <?php endif; ?>
                ...
                <form method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="heslo" class="form-control" id="heslo" required>
                    </div>
                    <button type="submit" class="btn btn-primary px-5 py-3"><?= preloz("prihlaseni"); ?></button>
                </form>
            </div>
        </div>
    </div>
