...
<!-- Nav Item - Charts -->
<li class="nav-item<?php if($controllerNazev === "blog") : ?> active<?php endif; ?>">
...
<!-- Nav Item - Tables -->
<li class="nav-item<?php if($controllerNazev === "uzivatel") : ?> active<?php endif; ?>">
  <a class="nav-link" href="?stranka=uzivatel">
